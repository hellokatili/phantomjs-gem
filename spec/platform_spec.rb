...
describe Phantomjs::Platform do
  ...
  describe "on a 64 bit linux" do
    ...
    it "reports the Win64 Platform as unuseable" do
      Phantomjs::Platform::Win64.should_not be_useable
    end
  end
  ...
  describe "on Windows 32 bit" do
    ...
    it "reports the Windows64 platform as unuseable" do
      Phantomjs::Platform::Win64.should_not be_useable
    end
  end

  describe "on Windows 64 bit" do
    before do
      Phantomjs::Platform.stub(:host_os).and_return('mingw32')
      Phantomjs::Platform.stub(:architecture).and_return('x86_64')
    end
    ...
    it "reports the Windows32 platform as unuseable" do
      Phantomjs::Platform::Win32.should_not be_useable
    end
  end
